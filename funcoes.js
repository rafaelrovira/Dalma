function vaiP1() { window.location.href = "login.html"; }
function vaiP2() { window.location.href = "produto.html"; }
function vaiP3() {
  if( getUser() != "" ) window.location.href = "lances.html";
  else document.getElementById( "saida" ).innerHTML = "acesso proibido";
}
function vaiP4() {
  if( getUser() != "" ) window.location.href = "produto.html";
  else document.getElementById( "saida" ).innerHTML = "acesso proibido";
}
